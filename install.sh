...
#fi
printf "       Host name [LoRaWAN-gateway]:"
read NEW_HOSTNAME
if [[ $NEW_HOSTNAME == "" ]]; then NEW_HOSTNAME="LoRaWAN-gateway"; fi

printf "       Descriptive name [MyLoRaWAN-RAK831]:"
read GATEWAY_NAME
if [[ $GATEWAY_NAME == "" ]]; then GATEWAY_NAME="MyLoRaWAN-RAK831"; fi
...
if [ ! -d lora_gateway ]; then
    git clone https://github.com/clodpi/lora_gateway.git
    pushd lora_gateway
else
    pushd lora_gateway
    git fetch origin
...
if [ ! -d packet_forwarder ]; then
    git clone https://github.com/clodpi/packet_forwarder.git
